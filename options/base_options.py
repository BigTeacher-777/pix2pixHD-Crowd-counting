...
class BaseOptions():
    ...
    def initialize(self):    
        ...
        self.parser.add_argument('--name', type=str, default='UCSD', help='name of the experiment. It decides where to store samples and models')        
        ...
        self.parser.add_argument('--dataroot',type=str,default='/media/zzk/ac85e160-664e-4db7-ac34-db0e2037cd27/pix2pixHD-master/UCSD_mcnn/')
        ...
        self.parser.add_argument('--no_instance', type=str,default=True, help='if specified, do *not* add instance map as input')
        self.parser.add_argument('--roi',action='store_true',help='if_specified,use roi')        
